...
class GestureGamingSystem:
    ...
    def start(self):
        ...
        print("📋 Directional Pointing Controls:")
        print("   🖐 Open Palm → Forward (W)")
        print("   ✊ Closed Fist → Backward (S)")
        print("   👈 Point Left → Strafe Left (A)")
        print("   👉 Point Right → Strafe Right (D)")
        print("   👆 Point Up → Jump (Space)")
        print("   🤘 Rock Sign → Attack (Left Click)")
        print("\n🔧 Controls:")
